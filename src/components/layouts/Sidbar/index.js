...
import { faMessage, faHeartPulse, faQuestionCircle } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <>
     <div className={classes.sid}>
      ...
      <Link to='/home/messages' className='link'>
        <div className="element">
            <h4 className='name'>Messages</h4>
            <FontAwesomeIcon className='icon' icon={faMessage} />
        </div>
      </Link>
      <Link to='/home/posts' className='link'>
        <div className="element">
